...
- Return new required fields in KeyringAccount objects ([#41](https://github.com/MetaMask/snap-tron-wallet/pull/41))
...
[1.4.0]: https://github.com/MetaMask/snap-tron-wallet/compare/v1.2.0...v1.4.0
