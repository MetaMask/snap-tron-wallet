...
- fix: use available `triggerConstantContract` instead of `estimateEnergy` ([#101](https://github.com/MetaMask/snap-tron-wallet/pull/101))
- fix: Use mutex for state blob modifications ([#93](https://github.com/MetaMask/snap-tron-wallet/pull/93))
