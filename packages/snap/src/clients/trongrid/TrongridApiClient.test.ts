...
import nativeTransferWithoutTimestampMock from '../../services/transaction-history/mocks/trongrid/account-transactions/native-transfer-without-timestamp.json';
import nativeTransferMock from '../../services/transaction-history/mocks/trongrid/account-transactions/native-transfer.json';
