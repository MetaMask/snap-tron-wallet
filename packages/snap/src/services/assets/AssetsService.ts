...
export class AssetsService {
  ...
  /**
   * Extracts bandwidth assets (current and maximum).
   *
   * @param account - The keyring account.
   * @param scope - The network.
   * @param resources - Account resources (energy, bandwidth).
   * @returns AssetEntity[] - Array containing bandwidth and maximum bandwidth assets.
   */
  #extractBandwidth(
    account: KeyringAccount,
    scope: Network,
    ...
    const bandwidth = maximumBandwidth - (resources?.freeNetUsed ?? 0);
  ...
  /**
   * Extracts energy assets (current and maximum).
   *
   * @param account - The keyring account.
   * @param scope - The network.
   * @param resources - Account resources (energy, bandwidth).
  ...
  #extractEnergy(
    ...
    const maximumEnergy = resources?.EnergyLimit ?? 0;
