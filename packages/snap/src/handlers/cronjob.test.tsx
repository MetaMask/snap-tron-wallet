...
describe('CronHandler', () => {
  ...
  describe('trackTransaction', () => {
    ...
    it('syncs accounts immediately on last attempt without scheduling another poll', async () => {
      ...
      // attempt = maxAttempts - 1 = 4 (last valid poll)
      await cronHandler.trackTransaction({
        txId: TX_ID,
        scope: Network.Mainnet,
        accountIds: ACCOUNT_IDS,
    ...
    it('does not schedule beyond maxAttempts when transaction stays unconfirmed', async () => {
      ...
      // Simulate all 5 attempts (0 through 4)
      ...
      // Attempts 0-3 (4 scheduling calls), attempt 4 triggers timeout instead
      expect(scheduleBackgroundEvent).toHaveBeenCalledTimes(4);
      // Attempt 4 should have synced accounts
